        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-20 gap-x-[8%] w-full'>
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              <p className='font-bold text-[1rem] text-primary text-left'>
                Find Your Dream Home.
              </p>
              <p className='text-left text-[14px]'>
                Choose from the variety of properties available on the platform.
              ...
              <div className='w-52 bg-white h-10 mt-2 mr-auto flex items-center justify-center gap-x-1 rounded-[2.5rem] border-2 border-primary'>
                <img
                  ...
                  className='w-6 h-6'
                />
                <h1 className='text-primary text-[8px]'>
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              ...
              <p className='text-left text-[14px]'>
                Choose the best way YOU want to buy your dream home. We do most
                of the hardwork by automatically calculating which properties
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              ...
              <p className='text-left text-[14px]'>
                We give you several options to book a viewing for the property.
                You can view it yourself, with our agent (for a small fee), or
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              ...
              <p className='text-left text-[14px]'>
                After you have booked a viewing and you are satisfied with the
                viewing, you acknowledge having viewed the property and then
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              ...
              <p className='text-left text-[14px]'>
                The partner (Developer or Bank) you applied to will process your
          ...
          >
            ...
            <div className='group-hover:bg-[#F3FAF2] p-5 rounded-xl transition-all'>
              ...
              <p className='text-left text-[14px]'>
                ...
                terms of your application and an offer letter or a term sheet
                for you to review. If you accept the terms, you can then proceed
